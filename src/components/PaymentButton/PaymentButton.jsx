...
function PaymentButton({ CLIENT_URL, text, amount, priceId, actorId, currentUser , onLoginAndNavigate}) {
  ...
  const handlePayment = async () => {
    ...
    if (!currentUser) {
      // Assuming onLoginAndNavigate is a function in the same component
      onLoginAndNavigate();
      return;
    }
