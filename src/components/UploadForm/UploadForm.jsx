...
function UploadForm({ backendURL }) {
    ...
    const compressImage = (file, callback) => {
        ...
        img.onload = () => {
            ...
            if (aspectRatio <= 1) {
                alert("Please upload a portrait photo (height should be greater than width).");
                callback(null);
                return;
            }
        ...
        <div className="form-container">
            ...
            <form className="form-container__form" onSubmit={handleSubmit}>
                ...
                <div className="input-group">
                    ...
                    {imagePreview && (
                        <div>
                            <img src={imagePreview} alt="Selected Preview" style={{ maxWidth: "100%", maxHeight: "300px" }} />
                ...
                <div className="input-group">
                    <input className="form-container__input" type="text" name="name" placeholder="Name" value={formData.name} onChange={handleInputChange} />
                </div>
